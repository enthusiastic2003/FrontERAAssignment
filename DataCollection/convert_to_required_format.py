...
def process_dataset(input_dir: str, prefix: str, output_dir: str, count: int, target_sr: int = 16000) -> None:
    """
...
def main():
    ...
    mozilla_control_path = "./tempData/MozillaControlData/cv-corpus-20.0-delta-2024-12-06/en/clips"
    ...
    process_dataset(kaggle_control_path, "kaggle_control", consistent_data_path_control, 511)
    process_dataset(libri_control_path, "libri_control", consistent_data_path_control, 1000)
    process_dataset(mozilla_control_path, "mozilla_control", consistent_data_path_control, 1000)

    # # Process youtube dataset
    # youtube_data_path_cry = "./tempData/YouTubeData/cry"
    # youtube_data_path_scream = "./tempData/YouTubeData/scream"
    #
    # process_dataset(youtube_data_path_cry, "youtube_cry", consistent_data_path_cry)
    # process_dataset(youtube_data_path_scream, "youtube_scream", consistent_data_path_scream)
